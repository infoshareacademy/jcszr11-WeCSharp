...
new User
{
    ...
    PositionId = 2,
            ...
            //    new WorkModeForUser() { Id = 1, DateOfWorkMode = new DateOnly(2024, 01, 10), WorkModeId = 1, UserId = "8e445865-a24d-4543-a6c6-9443d048cdb9" },
            //    new WorkModeForUser() { Id = 2, DateOfWorkMode = new DateOnly(2024, 01, 10), WorkModeId = 1, UserId = "8e445865-a24d-4543-a6c6-9443d048cdb9" },
            //    new WorkModeForUser() { Id = 3, DateOfWorkMode = new DateOnly(2024, 01, 11), WorkModeId = 1, UserId = "8e445865-a24d-4543-a6c6-9443d048cdb9" },
            //    new WorkModeForUser() { Id = 4, DateOfWorkMode = new DateOnly(2024, 01, 12), WorkModeId = 1, UserId = "8e445865-a24d-4543-a6c6-9443d048cdb9" },
            //    new WorkModeForUser() { Id = 5, DateOfWorkMode = new DateOnly(2024, 01, 13), WorkModeId = 1, UserId = "8e445865-a24d-4543-a6c6-9443d048cdb9" },
            //    new WorkModeForUser() { Id = 6, DateOfWorkMode = new DateOnly(2024, 01, 14), WorkModeId = 1, UserId = "8e445865-a24d-4543-a6c6-9443d048cdb9" }
            //);
            ...
            //    new CalendarEvent() { Id = 1, CalendarEventName = "Maintenance Work", CalendarEventDescription = "Ongoing maintenance tasks in the office", CalendarEventDate = new DateOnly(2024, 01, 10), CalendarEventStartTime = new TimeOnly(08, 30, 0), CalendarEventEndTime = new TimeOnly(09, 30, 0), UserId = "8e445865-a24d-4543-a6c6-9443d048cdb9" },
            //    new CalendarEvent() { Id = 2, CalendarEventName = "Office Cleaning", CalendarEventDescription = "Scheduled office cleaning day", CalendarEventDate = new DateOnly(2024, 01, 11), CalendarEventStartTime = new TimeOnly(09, 30, 0), CalendarEventEndTime = new TimeOnly(10, 30, 0), UserId = "8e445865-a24d-4543-a6c6-9443d048cdb9" },
            //    new CalendarEvent() { Id = 3, CalendarEventName = "Pottering", CalendarEventDescription = "Time for a relaxed atmosphere!", CalendarEventDate = new DateOnly(2024, 01, 11), CalendarEventStartTime = new TimeOnly(10, 30, 0), CalendarEventEndTime = new TimeOnly(11, 30, 0), UserId = "8e445865-a24d-4543-a6c6-9443d048cdb9" },
            //    new CalendarEvent() { Id = 4, CalendarEventName = "Project Meeting", CalendarEventDescription = "Team project meeting to discuss progress, challenges, and plans for project execution", CalendarEventDate = new DateOnly(2024, 01, 11), CalendarEventStartTime = new TimeOnly(11, 30, 0), CalendarEventEndTime = new TimeOnly(12, 30, 0), UserId = "8e445865-a24d-4543-a6c6-9443d048cdb9" },
            //    new CalendarEvent() { Id = 5, CalendarEventName = "Business Meeting", CalendarEventDescription = "Strategic business meeting covering company development, market strategy, and key decisions", CalendarEventDate = new DateOnly(2024, 01, 12), CalendarEventStartTime = new TimeOnly(12, 30, 0), CalendarEventEndTime = new TimeOnly(13, 30, 0), UserId = "8e445865-a24d-4543-a6c6-9443d048cdb9" },
            //    new CalendarEvent() { Id = 6, CalendarEventName = "Training Workshop", CalendarEventDescription = "Educational workshop aimed at enhancing employee's skills", CalendarEventDate = new DateOnly(2024, 01, 13), CalendarEventStartTime = new TimeOnly(13, 30, 0), CalendarEventEndTime = new TimeOnly(14, 30, 0), UserId = "8e445865-a24d-4543-a6c6-9443d048cdb9" }
            //);
            //builder.Entity<User>().HasData(
